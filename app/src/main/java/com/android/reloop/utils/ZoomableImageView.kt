    ...
    private fun initView() {
        ...
        tapDetector = GestureDetector(context, object : GestureDetector.SimpleOnGestureListener() {
            ...
            override fun onSingleTapConfirmed(e: MotionEvent): Boolean {
                onClickListener?.onClick(this@ZoomableImageView)
                return true
            }
            ...
            override fun onFling(
                ...
                ViewCompat.postOnAnimation(this@ZoomableImageView, flingRunnable)
                return true
            }
    ...
    private val flingRunnable = object : Runnable {
        ...
        override fun run() {
            if (!scroller.isFinished && scroller.computeScrollOffset()) {
                ...
                lastX = curX
                lastY = curY
                ViewCompat.postOnAnimation(this@ZoomableImageView, this)
            }
        }
    }
