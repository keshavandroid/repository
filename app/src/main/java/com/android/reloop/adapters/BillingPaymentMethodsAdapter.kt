...
class BillingPaymentMethodsAdapter() : RecyclerView.Adapter<BillingPaymentMethodsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        view = LayoutInflater.from(parent.context).inflate(R.layout.item_row_billing_payment_method, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
     ...
     /*   holder.itemView.setOnClickListener {
        ...
        holder.ivdelete.setOnClickListener {
            itemClickListener!!.deletePaymentMethod(position)
        }
    }
    ...
    interface ItemClickListener {
       ...
       fun itemclick(position: Int, paymentMethods: PaymentMethods)
       fun deletePaymentMethod(position: Int)
    }
