...
class CollectionImagesPagerAdapter(
    context: Context,
    ...
    interface ItemClickListener {
        fun itemclickSlide(position: Int,imageURL: ArrayList<String>)
    }
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        if (type == 1) {
            itemView =
                layoutInflater.inflate(R.layout.new_slider_layout_collection, container, false)
        } else {
