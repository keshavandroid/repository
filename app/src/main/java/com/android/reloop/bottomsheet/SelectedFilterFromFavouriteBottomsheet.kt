...
class SelectedFilterFromFavouriteBottomsheet : BottomSheetDialogFragment() {
  ...
  fun newInstance(
    ...
    header: String?,
    isFavorite: Boolean
  ): SelectedFilterFromFavouriteBottomsheet {

    val fragment = SelectedFilterFromFavouriteBottomsheet()
...
//    headerTV.text = requireArguments().getString("header")
    ...
    btnStartDropOff.setOnClickListener{
      mListener?.onSelectStationFromFavorite(materialCategories)
      dismiss()
    }
  ...
  interface ItemClickListener {
    fun onSelectStationFromFavorite(value: ArrayList<MaterialCategories>)
