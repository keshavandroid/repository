...
import com.reloop.reloop.activities.HomeActivityGuest
 ...
 */
class RewardsFragmentGuest : BaseFragment(), RecyclerViewItemClick, OnNetworkResponse,
    AlertDialogCallback {

    companion object {
        fun newInstance(): RewardsFragmentGuest {
            return RewardsFragmentGuest()
        }
    }
...
//            totalPoints?.text = User.retrieveUser()?.reward_points?.let { Utils.commaConversion(it) }
    ...
    override fun onCreateView(
        ...
        val view: View? = inflater.inflate(R.layout.fragment_rewards_guest, container, false)
        initViews(view)
        setListeners()
        return view
    }
    ...
    private fun setClickSpan(textToUnderLine: String) {
        val clickableSpan: ClickableSpan = object : ClickableSpan() {
            ...
            override fun onClick(widget: View) {
                ...
                if (HomeActivityGuest.bottomNav.selectedItemId != R.id.navigation_shop) {
                    HomeActivityGuest.bottomNav.selectedItemId = R.id.navigation_shop
                }
            }
        }
