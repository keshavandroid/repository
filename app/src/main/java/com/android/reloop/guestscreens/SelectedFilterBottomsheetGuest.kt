...
class SelectedFilterBottomsheetGuest : BottomSheetDialogFragment() {
  ...
  fun newInstance(
    ...
    header: String?
  ): SelectedFilterBottomsheetGuest {

    val fragment = SelectedFilterBottomsheetGuest()
  ...
  override fun onCreateView(
    ...
    return inflater.inflate(R.layout.bottomsheet_selected_filter_guest, container, false)
  }
...
//    headerTV.text = requireArguments().getString("header")
  ...
  internal class MaterialAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
      ...
      Utils.glideImageLoaderServer(
        imgMaterialCat,
        materialList.get(position).avatar,
